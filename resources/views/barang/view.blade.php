...
<div class="card card-outline card-primary">
    <div class="card-header">
      ...
      <div class="float-right">
        ...
        <a href="export_excel/barang" class="btn btn-success btn-sm"><i class="fas fa-file-export"></i> Export Excel</a>
    ...
    <div class="card-body">
      ...
      <table id="example1" class="table table-bordered table-striped">
        ...
        <tr>
          ...
          <td class="align-middle text-center">
            <a href="barang/detail/{{ $item->id }}" class="btn btn-primary"><i class="fas fa-info-circle"></i> Detail</a>
          </td>
        </tr>
